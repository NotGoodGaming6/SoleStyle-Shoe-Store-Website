...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      ...
      >
        <SpotlightCard
          className="p-3 rounded-2xl border border-gray-200/50 bg-white/50 backdrop-blur-md dark:border-gray-800/50 dark:bg-gray-950/20 shadow-sm transition-all duration-300 hover:shadow-md hover:border-primary-500/20 h-full flex flex-col justify-between"
          spotlightColor="rgba(79, 70, 229, 0.12)"
        >
          <Link to={`/products/${product.id}`} className="block overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800">
