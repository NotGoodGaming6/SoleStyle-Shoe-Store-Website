...
const StatCard = ({ stat, index }) => {
  return (
    ...
    >
      <SpotlightCard
        className="rounded-[2rem] border border-gray-200 bg-white p-8 shadow-sm transition-all hover:shadow-xl dark:border-gray-800 dark:bg-gray-900 h-full flex flex-col justify-between"
