      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        >
          {[
            ...
            >
              <SpotlightCard
                className="rounded-2xl border border-gray-800/80 bg-gray-900/40 p-8 h-full flex flex-col justify-between transition-all duration-300 hover:border-primary-500/20"
